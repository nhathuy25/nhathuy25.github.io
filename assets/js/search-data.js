    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-i-joined-orange-innovation-as-a-research-engineer-intern-on-energy-efficient-large-language-models",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6E%67%75%79%65%6E%68%75%75%6E%68%61%74%68%75%79%32%35%30%32@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/nhathuy25", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/huy-nguyen25", "_blank");
        },
      },{
      id: 'light-theme',
